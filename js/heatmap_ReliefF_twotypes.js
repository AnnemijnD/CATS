...
var datapath = "../";
try {
  d3.csv(datapath + "results_features_good/two_subtypes_freq.csv", function(data) {
    console.log(data)
  })
}
catch(err) {
...
var datapath = "../";
try {
  d3.csv(datapath +"results_features_good/wotypes_freq.csv",function(data) {
    console.log(data)
  })
}
catch(err) {
...
d3.csv(datapath+ "results_features_good/two_subtypes_feat.csv", function(data) {
var feature_array = [];
var type_array = [];
